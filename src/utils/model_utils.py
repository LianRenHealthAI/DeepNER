...
class CRFModel(BaseModel):
    ...
    def forward(
        self, token_ids, attention_masks, token_type_ids, labels=None, pseudo=None
    ):
            ...
            if pseudo is not None:
                ...
                if pseudo_nums == 0:
                    ...
                    if total_nums == pseudo_nums:
                        ...
                        loss_0 = ((1 - rate) * (1 - pseudo) * tokens_loss).sum() / (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.use_type_embed:
            embed_dims = kwargs.pop(
                "predicate_embed_dims", self.bert_config.hidden_size
            )
...
class EnsembleCRFModel:
    ...
    def predict(self, model_inputs):
        ...
        tokens_out = self.crf_module.decode(
            emissions=logits, mask=attention_masks.byte()
        )
